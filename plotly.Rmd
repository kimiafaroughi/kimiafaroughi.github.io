...
ggplotly(ggp_scatterplot) #not as good as plot_ly, but if you need something for yourself really quickly
```

**code for dashboard `r rmarkdown::render("dashboard.Rmd", output_format = "flexdashboard::flex_dashboard")`**